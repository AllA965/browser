...
public class ClearBrowsingDataDialog : Form
{
    ...
    private void InitializeUI()
    {
        ...
        // 时间范围
        var timeLabel = new Label { Text = "清除指定时间段内的数据:", Location = new Point(20, y), AutoSize = true };
        ...
        // 分隔线
        var separator = new Panel { Location = new Point(20, y), Size = new Size(390, 1), BackColor = Color.FromArgb(220, 220, 220) };
        ...
        // 分隔线
        var separator2 = new Panel { Location = new Point(20, y), Size = new Size(390, 1), BackColor = Color.FromArgb(220, 220, 220) };
